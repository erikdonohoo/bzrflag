...
public class DumbAgent extends AbstractAgent{
	protected static final int MOVE_MIN = 3;
	protected static final int MOVE_MAX = 8;

	protected static final float SHOOT_MIN = 1.5f;
	protected static final float SHOOT_MAX = 2.5f;
	/**
	 * If 0 it's moving, if 1 it's turning
	 */
	protected int state;

	public Date lastShoot;
	public Date startState;
